  ...
  const logo = (
    <Box sx={{ width: 100, height: 100, ...sx }}>
      ...
      >
        ...
        <g transform="translate(0.000000,433.000000) scale(0.100000,-0.100000)" fill={PRIMARY_MAIN} stroke="none">
          <path
            d="M2405 3313 c11 -78 33 -137 75 -197 22 -32 40 -59 40 -61 0 -3 -40
...
218 189 122 169 153 379 84 565 -25 68 -102 197 -174 292 -82 109 -106 163
        -106 237 0 51 6 73 30 115 42 74 119 123 195 126 24 1 42 3 41 4 -4 4 -657
         273 -663 273 -2 0 -1 -21 2 -47z"
          />
          <path
            d="M2914 2916 c-39 -33 -39 -89 0 -122 57 -50 138 -14 138 61 0 75 -81
111 -138 61z"
          />
        </g>
      </svg>
