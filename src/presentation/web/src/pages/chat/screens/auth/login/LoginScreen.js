...
const LoginScreen = ({ location }) => {
  ...
  const getLoginMessage = () => {
    if (location && location.state && location.state.redirectFrom === AppPaths.SIGN_UP) {
      return <div id="loginMessage">Your account has been created successfully. Please login.</div>;
    }
    return null;
  };
      ...
      <div id="authForm">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="authFieldContainer">
            ...
            />
            {errors.username && <p className="requiredFieldError">This field is required</p>}
          </div>
          <div className="authFieldContainer">
            <input
              className="authField"
            ...
            />
            {errors.password && <p className="requiredFieldError">This field is required</p>}
          </div>
          <br />
        ...
        <p id="authFormFooter">
          Don't have any account! <Link to="/signup">Click here</Link> to singup.
        </p>
      </div>
    </div>
  );
